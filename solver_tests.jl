...
tpneldermead = ThermodynamicProperties(P= 1.0, T = 300, 
	opt_prob_gen=DEFAULT_OPT_PROB_GENERATOR,
	solver=NelderMead(), return_sol=true)

# ╔═╡ d6b8c891-ae6c-4a51-a499-0142e397d957
mpneldermead = MassProperties(P=1, T=300, MM=29,
	opt_prob_gen=DEFAULT_OPT_PROB_GENERATOR,
	solver = NelderMead(), return_sol=true)[2].original

# ╔═╡ d6c94f87-c5f1-4593-bed4-11fe2b7e596a
calpneldermead = CalorificProperties(P=1, T=300, MM=0.029, gamma=1.4,
	opt_prob_gen=DEFAULT_OPT_PROB_GENERATOR,
	solver = NelderMead(), return_sol=true)

# ╔═╡ 528beb52-254f-467b-a20e-bbc677af47fe
fpneldermead = FlowProperties(P = 1, T=300, MM=0.029, gamma=1.4, M = 1,
	opt_prob_gen=DEFAULT_OPT_PROB_GENERATOR,
	solver = NelderMead(), return_sol=true)[2].original
...
version = "3.3.3"
    ...
    [RecursiveArrayTools.extensions]
...
version = "2.16.0"
    ...
    [SparseDiffTools.extensions]
    SparseDiffToolsEnzymeExt = "Enzyme"
    SparseDiffToolsPolyesterForwardDiffExt = "PolyesterForwardDiff"
    SparseDiffToolsSymbolicsExt = "Symbolics"
    SparseDiffToolsZygoteExt = "Zygote"

    [SparseDiffTools.weakdeps]
    Enzyme = "7da242da-08ed-463a-9acd-ee780be4f1d9"
    PolyesterForwardDiff = "98d1487c-24ca-40b6-b7ab-df2af84e126b"
    Symbolics = "0c5d862f-8b57-4792-8d23-62f2024744c7"
    Zygote = "e88e6eb3-aa80-5325-afca-941959d7151f"
